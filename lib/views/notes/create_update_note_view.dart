...
import "package:ocd/utilities/generics/get_arguments.dart";
...
import "package:ocd/utilities/dialogs/cannot_share_empty_note_dialog.dart";
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    //exctract argument of DatabaseNote
        ...
        builder: (context, snapshot) {
          switch (snapshot.connectionState) {
            case ConnectionState.done:
              //Very important to have DatabaseNote to be optionally nullable
